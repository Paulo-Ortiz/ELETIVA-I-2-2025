...
<title>Insira a largura e a altura de um retângulo</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" >
</head>
<body> 
<div class="container">
<h1>Insira a largura e a altura de um retângulo</h1>
<form method="post">
<div class="mb-3">
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {    
        ...
        echo "<p></p>";
        echo "<p>A área do retângulo é: " . number_format($retangulo, 2, ",", ".") . " unidades²</p>";
    }
?>
